...
<%@page import="code.code.dao.UserDao"%>
    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header primary_background">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row my-3 row-user">
                                ...
                                <div class="col-md-6">
                                    <p class="post-date">Posted on :<%= DateFormat.getDateTimeInstance().format(p.getpDate())%></p>
                                </div>
                            </div>
            ...
            <!--<a href="show_blog_page.jsp?post_id=<%= p.getpId()%>" class="btn btn-outline-light btn-sm primary_background" style="border-radius: 6px;">Read more...</a>-->
                            ...
                            %>
                            <a href="#" onclick="doLike(<%=p.getpId()%>,<%=user.getId()%>)" class="btn btn-outline-light btn-sm primary_background" style="border-radius: 6px;"><i class="fa fa-thumbs-o-up"></i><span class="like-counter">10</span></a>
